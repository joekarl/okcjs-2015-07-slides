ObjLoader = (function() {
	...
	for (i = 0; i < lines.length; ++i) {
		...
		vNCoordStore.push([vNormal[1], vNormal[2], vNormal[3]]);
	...
	const imageUrlParts = objMaterial.image.src.split('\.');
	...
	gl.texImage2D(gl.TEXTURE_2D, 0, textureType, textureType, gl.UNSIGNED_BYTE, objMaterial.image);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
	
	return new Model(vertexBuffer, texCoordBuffer, textureId, obj.vertexCoordinates.length / 3);
    }
