 ...
 */
Model.prototype.draw = function(gl, vertexAttr, texCoordsAttr, textureUnif, modelMatrixUnif, cameraMatrixUniform, transformMatrix, cameraMatrix) {
    ...
    gl.uniformMatrix4fv(cameraMatrixUniform, false, cameraMatrix);
...
ModelGroup.prototype.draw = function(gl, vertexAttr, texCoordsAttr, textureUnif, modelMatrixUnif, cameraMatrixUniform, cameraMatrix) {
    this.models.forEach(function(model) {
	model.draw(gl, vertexAttr, texCoordsAttr, textureUnif, modelMatrixUnif, cameraMatrixUniform, cameraMatrix, this.modelMatrix);
    }.bind(this));
};
